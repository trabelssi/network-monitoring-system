    ...
    private function saveDevice($ip, $snmpData, $classification, $icmpStatus)
    {
        return Device::updateOrCreate(
            ...
            [
                ...
                'is_alive' => $icmpStatus === 'online',
                'snmp_available' => $snmpData['status'] === 'available',
                'sys_descr' => $this->cleanSNMPValue($snmpData['sys_descr'] ?? null),
                'sys_location' => $this->cleanSNMPValue($snmpData['sys_location'] ?? null),
                'last_seen' => now(),
                'auto_assigned' => true,
                'assignment_date' => now(),
            ]
