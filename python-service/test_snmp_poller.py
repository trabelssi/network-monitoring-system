...
from snmp_poller import (
    SNMPConfig, SNMPVersion, SNMPOIDs, SNMPResult,
    SNMPPoller, DeviceClassifier
)
...
class TestSNMPConfig:
    ...
    def test_from_env_with_defaults(self, monkeypatch):
        ...
        for key in ["SNMP_COMMUNITY", "SNMP_VERSION", "SNMP_TIMEOUT", "SNMP_RETRIES", "SNMP_PORT"]:
...
class TestSNMPPoller:
    ...
    def test_query_device_success(self, mock_getcmd):
        ...
        mock_getcmd.return_value = iter([(
            ...
            None,  # error_status
            None,  # error_index
            [mock_varbind_1, mock_varbind_2, mock_varbind_3, mock_varbind_4, mock_varbind_5]
        )])
    ...
    def test_query_with_communities_all_fail(self):
        ...
        with patch.object(poller, 'query_device') as mock_query:
            ...
            result = poller.query_with_communities("192.168.1.1", ["public", "private", "community"])
